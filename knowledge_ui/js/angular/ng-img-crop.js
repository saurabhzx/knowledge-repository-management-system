/*! ngImgCrop v0.2.0 License: MIT */ ! function() {
    ...
    e.factory("cropAreaCircle", ["cropArea",
        function(e) {
            var t = function() {
    ...
    ]), e.factory("cropAreaSquare", ["cropArea",
        function(e) {
            var t = function() {
    ...
    ]), e.factory("cropHost", ["$document", "cropAreaCircle", "cropAreaSquare",
        function(e, t, i) {
            var s = function(e) {
    ...
    ]), e.directive("imgCrop", ["$timeout", "cropHost", "cropPubSub",
        function(e, t, i) {
            return {
                restrict: "E",
                scope: {
